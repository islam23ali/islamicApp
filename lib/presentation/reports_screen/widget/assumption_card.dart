...
class AssumptionCard extends StatefulWidget {
  const AssumptionCard({Key? key, Color? gradientColor1}) : gradientColor1 = gradientColor1 ?? Colors.blue;
  final Color gradientColor1;
  @override
  _AssumptionCardState createState() => _AssumptionCardState();
}

class _AssumptionCardState extends State<AssumptionCard> {
