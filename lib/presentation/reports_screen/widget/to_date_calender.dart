...
class ToDateCalender extends StatefulWidget {
  ...
  @override
  _ToDateCalenderState createState() => _ToDateCalenderState();
}
  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        ...
        (showDate!=true)? SizedBox(): Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(12.r),color: Colors.transparent,
            border: Border.all(width: 3,color: AppColors.grayLight)),
          child: Column(
            children: [
              InkWell(onTap: (){
                setState(() {
