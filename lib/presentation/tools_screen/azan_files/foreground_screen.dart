...
import 'package:islamic_app/presentation/tools_screen/azan_files/home_screen.dart';
import 'package:islamic_app/presentation/tools_screen/azan_files/models.dart';
import 'package:islamic_app/presentation/tools_screen/azan_files/pref.dart';
import 'package:islamic_app/presentation/tools_screen/azan_files/time_util.dart';
// import 'package:testazan2/home_screen.dart';
// import 'package:testazan2/models.dart';
// import 'package:testazan2/pref.dart';
// import 'package:testazan2/time_util.dart';
    ...
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: screenHeight / 3, child: cardWidget(context))
        ],
      ),
    );
  }
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              //             style: const TextStyle(fontFamily: "Sukar",fontSize: 18),
